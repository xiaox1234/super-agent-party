      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'enabledExpressions': 'Enable Expressions Control (TTS needs to be enabled)',
        'enabledMotions': 'Enable Motions Control (TTS needs to be enabled)',
...
Key3`,
        ...
        'localEnvironmentNotice1': 'In a local environment, do not grant excessive permissions to the AI to avoid system damage. On macOS/Linux systems, the zerobox project is used to achieve native sandbox isolation. On Windows systems, only soft fence isolation is implemented, pending future updates. If you want the AI to run in a more secure environment, you can choose the Docker secure sandbox mode.',
        ...
        'vtsURL': 'VTS API URL',
        'enabledVtsExpressions': 'Enable VTS Expressions (TTS needs to be enabled)',
        'enabledVtsMotions': 'Enable VTS Motions (TTS needs to be enabled)',
