      ...
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'refreshWindow': '刷新窗口',
        'closeWindow': '关闭窗口',
        'enabledExpressions': '启用表情控制（需开启语音合成）',
        'enabledMotions': '启用动作控制（需开启语音合成）',
...
key3`,
        ...
        'localEnvironmentNotice1': '本地环境下，请不要给AI过多权限，以免造成系统损坏，mac/linux系统中采用zerobox项目实现原生沙盒隔离，windows系统仅用软护栏隔离，需等待后续更新，如果你希望AI能在更安全的环境下运行，可以选择Docker安全沙箱模式',
        ...
        'stop_vts': '停止VTS机器人',
        'vtsURL': 'VTS API URL',
        'enabledVtsExpressions': '启用VTS表情（需开启语音合成）',
        'enabledVtsMotions': '启用VTS动作（需开启语音合成）',
        'connectToVTS': '连接到VTS',
        'allModel': '全部',
        'cloudModel': '云端',
        'localModel': '本地',
